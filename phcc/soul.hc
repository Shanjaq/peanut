...
void  ()necro_soul_touch =  {
	...
	if ( ((other.classname == "player") && (other.playerclass == CLASS_NECROMANCER)) ) {
		sound ( self, CHAN_VOICE, "items/artpkup.wav", 1.00000, ATTN_NORM);
		other.health += ((self.search_time - time) * 2.00000);
		if ( (other.health > other.max_health) ) {
			other.health = other.max_health;
		}
		other.bluemana += ((self.search_time - time) * 2.00000);
		if ( (other.bluemana > other.max_mana) ) {
			other.bluemana = other.max_mana;
		}
		other.greenmana += ((self.search_time - time) * 2.00000);
		if ( (other.greenmana > other.max_mana) ) {
			other.greenmana = other.max_mana;
		}
		other.elemana += ((self.search_time - time) * 2.00000);
...
void  ()soul_move =  {
	...
	if ( (self.classname == "soulskull") ) {
		...
		//particle2 ( (self.origin - '0.00000 0.00000 20.00000'), vel, vel, p_color, PARTICLETYPE_C_EXPLODE, ((self.search_time - time) / 4.00000));
	} else {
		if ( (self.classname == "soulcross") ) {
			p_color = 176.00000;
			vel = random('-1.44000 -1.44000 65.00000','1.44000 1.44000 35.00000');
			particle2 ( (self.origin + '0.00000 0.00000 25.00000'), vel, vel, p_color, PARTICLETYPE_C_EXPLODE, ((self.search_time - time) / 4.00000));
		}
	}
...
void  (entity ent)necromancer_sphere =  {
	...
	new2.search_time = (time + new2.lifespan);
	new2.touch = necro_soul_touch;
	new2.think = soul_move;
	AdvanceThinkTime(new2,0.10000);
	/*
new2.health = (new2.lifespan * 2.00000);
new2.bluemana = (new2.lifespan * 2.00000);
new2.greenmana = (new2.lifespan * 2.00000);
new2.elemana = (new2.lifespan * 2.00000);
*/
