...
void  (entity voyeur,entity viewthing,float x, float y, float z)CameraViewAngles =  {
   msg_entity = voyeur;
  ...
  // WriteAngle ( MSG_ONE, (360.00000 - viewthing.angles_x));
   WriteAngle ( MSG_ONE, viewthing.angles_x + x);
   WriteAngle ( MSG_ONE, viewthing.angles_y + y);
   WriteAngle ( MSG_ONE, viewthing.angles_z + z);
