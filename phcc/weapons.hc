			...
			if ( (check_weapon == IT_WEAPON3) ) {
				...
				if ( (check_weapon == IT_WEAPON2) ) {
					...
					if ( (self.artifact_active & ART_TOMEOFPOWER) ) {
						...
						//     if ( (self.bluemana >= 3.00000) && (self.arrows >= 1.00000) ) {
...
void  ()CheatCommand =  {
	...
	self.items |= (((((IT_WEAPON1 | IT_WEAPON2) | IT_WEAPON3) | IT_WEAPON4 | IT_WEAPON5) | IT_WEAPON4_1) | IT_WEAPON4_2);
