...
if (self.pie == 0) {
   ...
   setsize ( self, '-24.00000 -24.00000 0.00000', '24.00000 24.00000 64.00000'); // BAER changed from 80
   GolemInit ( );
   ...
   self.proj_ofs = '0.00000 0.00000 64.00000';
...
if (self.pie == 0) {
   ...
   setsize ( self, '-24.00000 -24.00000 0.00000', '24.00000 24.00000 64.00000'); // BAER changed 64 from 80, and 24 from 32.
   GolemInit ( );
...
if (self.pie == 0) {
   ...
   setsize ( self, '-30.00000 -30.00000 0.00000', '30.00000 30.00000 80.00000'); // BAER halved all golem sides, and reduced top to 80.
   GolemInit ( );
   ...
   self.proj_ofs = '0.00000 0.00000 115.00000';
...
void  ()monster_golem_crystal =  {
   ...
   setmodel ( self, "models/golem_s.mdl");
   setsize ( self, '-24.00000 -24.00000 0.00000', '24.00000 24.00000 80.00000');
   GolemInit ( );
   self.hull = HULL_PLAYER;
...
void  ()GolemInit =  {
   ...
   self.mass = 75.00000;
   self.mintel = 2.00000;
   //self.hull = HULL_GOLEM; BAER changed sizes so monsters can fit down stairs and such
...
local float r = 0.00000;
   ...
   if ( (self.classname == "monster_golem_bronze") ) {
      ...
      if ( (dist < 100.00000) ) {
         ...
         if ( (((dist > 256.00000) && visible ( self.enemy)) && (r < 0.60000)) ) {
            ...
            if ( (((dist > 100.00000) && (dist < 256.00000)) && (r < 0.30000)) ) {
   ...
   if ( (self.classname == "monster_golem_iron") ) {
      ...
      if ( (dist < 100.00000) ) {
         ...
         if ( (((dist > 100.00000) && visible ( self.enemy)) && (r < 0.40000)) ) {
