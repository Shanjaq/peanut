...
local vector spot2 = '0.00000 0.00000 0.00000';
   ...
   if ( (trace_fraction == 1.00000) ) {
      ...
      if ( (forent.flags & FL_MONSTER) ) {
         ...
         if ( visibility_good ( targ, (0.15000 - (skill / 20.00000))) ) {
...
local entity client;
local float r = 0.00000;
//   if ( (!deathmatch && ((self.classname == "monster_imp_lord") || (self.classname == "cube_of_force") || (self.pie == 66))) ) {  //necromancy
   ...
   if ( !visibility_good ( client, 5.00000) ) {
...
local float have_monsters = 0.00000;
   if ( (self.spawnflags & IMP) ) {
      ...
      precache_model3 ( "models/h_imp.mdl");
...
local vector org;
	...
	local float foundspot,founddead;
