...
local float c_level = 0.00000;
   ...
   if ( trace_ent.takedamage ) {
      ...
      if ( (((((trace_ent.flags2 & FL_ALIVE) && !infront_of_ent ( self, trace_ent)) && (self.playerclass == CLASS_ASSASSIN)) && (self.weapon == IT_WEAPON1)) && (self.level > 5.00000)) ) {
         ...
         if ( (random(1.00000,10.00000) <= (c_level - 4.00000)) ) {
