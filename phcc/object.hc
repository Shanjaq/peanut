...
void  (entity loser)obj_fly_hurt =  {
	...
	if ( (((self.last_onground + 0.30000) < time) || (((self.last_onground + 0.10000) < time) && (loser.thingtype >= THINGTYPE_GLASS))) ) {
...
void  ()obj_ntree =  {
	precache_model2 ( "models/ntree.mdl");
	CreateEntityNew ( self, ENT_TREEDEAD, "models/ntree.mdl", chunk_death);
};
...
void  ()obj_ntree2 =  {
	local entity top;
	precache_model ( "models/ntree.mdl");
	CreateEntityNew ( self, ENT_TREE, "models/ntree.mdl", tree2_death);
	top = spawn ( );
	top.scale = self.scale;
	// CreateEntityNew ( top, ENT_TREETOP, top.model, tree2_death);
	top.origin = self.origin;
...
void  ()obj_shopcart =  {
	...
	CreateEntityNew ( self, ENT_CART, "models/shop1.mdl", chunk_death);
	self.health = 999999;
	self.mass = 9999;
	...
	if ( other.takedamage ) {
		...
		if ( ((other != self.goalentity) && (self.velocity != '0.00000 0.00000 0.00000')) ) {
			...
			if ( (other.thingtype == THINGTYPE_FLESH) ) {
				...
				MeatChunks ( trace_endpos, ((self.velocity * 0.50000) + '0.00000 0.00000 200.00000'), 3.00000, trace_ent);
