...
local vector randomvec = '0.00000 0.00000 0.00000';
   ...
   if ( other.takedamage ) {
      ...
      T_Damage ( other, self, self.owner, (self.dmg * 8.00000));
...
//   InstantDamage ( 8.00000, dir, '0.10000 0.10000 0.10000');
...
void  ()boneshard_fire =  {
   ...
   if ( !(self.artifact_active & ART_TOMEOFPOWER) && (self.weaponframe <= 5.00000) ) {
