...
local float zofs = 0.00000;
   ...
   if ( (self.frame == 37.00000) ) {
      ...
      traceline ( (self.origin + '0.00000 0.00000 30.00000'), (((self.origin + '0.00000 0.00000 30.00000') + (v_forward * 36.00000)) + (v_up * zofs)), FALSE, self);
      if ( (trace_fraction == 1.00000) ) {
   ...
   if ( cycle_wrapped ) {
      ...
      if ( (self.frame == 190.00000) ) {
         ...
         if ( ((self.frame >= 195.00000) && (self.frame <= 199.00000)) ) {
            ...
            traceline ( (self.origin + '0.00000 0.00000 37.00000'), (((self.origin + '0.00000 0.00000 37.00000') + (dir * 48.00000)) + (v_up * zofs)), FALSE, self);
            if ( (trace_fraction == 1.00000) ) {
            ...
            if ( ((trace_ent.thingtype == THINGTYPE_FLESH) && (self.frame == 198.00000)) ) {
               ...
               MeatChunks ( trace_endpos, ((v_right * random(-100.00000,-300.00000)) + '0.00000 0.00000 200.00000'), 3.00000, trace_ent);
