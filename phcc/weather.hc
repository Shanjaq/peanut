...
void  ()weather_box_rain = {
	newmis = spawn();
	newmis.solid = SOLID_NOT;
	newmis.movetype = MOVETYPE_FLY;
	newmis.counter = 300.00;
	newmis.color = 414.00;
	newmis.wait = 0.10;
	newmis.soundtype = 0.00;
	newmis.spawnflags |= RAIN_STRAIGHT;
	setorigin(newmis, self.origin);
	newmis.cnt = 1.00;
	setsize ( newmis, '-90.00000 -90.00000 -90.00000', '90.00000 90.00000 90.00000');
	AdvanceThinkTime(newmis, 0.02);
	newmis.think = weather_rain;
};
